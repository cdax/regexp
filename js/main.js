...
.directive('rpText', function($window, $document) {
	...
	var el_default = '<p>Welcome to RegEx Playground!</p><br /><p>This is a simple JavaScript regular expression tester. Start typing an expression above and see matches as you type. Since this is an early test release, there might be a few annoying bugs (https://github.com/c-das/regexp/issues), but I hope you enjoy using this tool all the same.</p><br /><br /><p>--Chitharanjan Das</p>';

...
.directive('rpText', function($window, $document) {
	...
	var el_default = '<p>Welcome to RegEx Playground!</p><br /><p>This is a simple JavaScript regular expression tester. Start typing into an expression above and start seeing matches as you type. Since this is an early test release, there might be a few annoying bugs (https://github.com/c-das/regexp/issues).</p><p>--Chitharanjan Das</p>';
